...
DEFAULT_TOPIC="A changelog generator that reads git history between two tags and produces a formatted CHANGELOG entry. Group commits by type and include links to PRs and issues."
DEFAULT_CONTEXT="Follow Keep a Changelog format. Support conventional commits for automatic categorization."
